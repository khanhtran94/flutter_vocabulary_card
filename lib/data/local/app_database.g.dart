...
class $CardsTable extends Cards with TableInfo<$CardsTable, Card> {
  ...
  static const VerificationMeta _vietnameseMeta = const VerificationMeta(
    'vietnamese',
  );
  @override
  ...
  VerificationContext validateIntegrity(
    ...
    if (data.containsKey('vietnamese')) {
      context.handle(
        _vietnameseMeta,
        vietnamese.isAcceptableOrUnknown(data['vietnamese']!, _vietnameseMeta),
      );
    } else if (isInserting) {
  ...
  Card map(Map<String, dynamic> data, {String? tablePrefix}) {
    ...
    return Card(
      ...
      vietnamese: attachedDatabase.typeMapping.read(
        DriftSqlType.string,
        data['${effectivePrefix}vietnamese'],
      )!,
...
class Card extends DataClass implements Insertable<Card> {
  ...
  Card copyWithCompanion(CardsCompanion data) {
    return Card(
      ...
      vietnamese: data.vietnamese.present
          ? data.vietnamese.value
          : this.vietnamese,
...
class ReviewLog extends DataClass implements Insertable<ReviewLog> {
  ...
  @override
  int get hashCode =>
      Object.hash(id, cardId, isCorrect, answerType, reviewedAt);
  @override
  bool operator ==(Object other) =>
      identical(this, other) ||
      (other is ReviewLog &&
...
class $$CardsTableFilterComposer extends Composer<_$AppDatabase, $CardsTable> {
  ...
  ColumnFilters<String> get vietnamese => $composableBuilder(
    column: $table.vietnamese,
    builder: (column) => ColumnFilters(column),
  );
...
class $$CardsTableOrderingComposer
  ...
  ColumnOrderings<String> get vietnamese => $composableBuilder(
    column: $table.vietnamese,
    builder: (column) => ColumnOrderings(column),
  );
...
class $$CardsTableAnnotationComposer
  ...
  GeneratedColumn<String> get vietnamese => $composableBuilder(
    column: $table.vietnamese,
    builder: (column) => column,
  );
        ...
        TableManagerState(
          ...
          updateCompanionCallback:
              ({
                ...
                Value<String> vietnamese = const Value.absent(),
                Value<String?> audioPath = const Value.absent(),
