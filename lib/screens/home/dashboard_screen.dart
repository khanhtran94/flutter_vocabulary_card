  ...
  Widget build(BuildContext context) {
    ...
    return AppShell(
      ...
      child: ListView(
        ...
        children: [
          _HeroCard(
            title: 'Hôm nay b?n dã h?c 18 t?',
            subtitle: 'Còn 6 t? n?a d? hoàn thành m?c tiêu 30 t?.',
            progress: 0.6,
          ...
          Row(
            children: [
              Expanded(child: _StatCard(label: 'Ðã nh?', value: '142', icon: Icons.check_circle_outline, color: AppColors.secondary)),
              SizedBox(width: scale.w(12)),
              Expanded(child: _StatCard(label: 'C?n ôn', value: '28', icon: Icons.refresh_outlined, color: AppColors.danger)),
            ],
          ),
          SizedBox(height: scale.h(16)),
          ...
          GridView.count(
            ...
            children: const [
              _ShortcutCard(title: 'Dán van b?n', icon: Icons.paste_outlined, color: AppColors.primary),
              _ShortcutCard(title: 'B? th?', icon: Icons.collections_bookmark_outlined, color: AppColors.secondary),
              _ShortcutCard(title: 'L?ch ôn', icon: Icons.calendar_month_outlined, color: AppColors.tertiary),
              _ShortcutCard(title: 'Th?ng kê', icon: Icons.bar_chart_outlined, color: AppColors.primaryDark),
            ],
          ),
          SizedBox(height: scale.h(16)),
